				...
				foreach ($types as $type) {
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="heading_<?php echo $type; ?>">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_<?php echo $type; ?>" aria-expanded="false" aria-controls="collapse_<?php echo $type; ?>">
								<?php echo $type; ?>
                            </button>
                        </h2>
                        <div id="collapse_<?php echo $type; ?>" class="accordion-collapse collapse" aria-labelledby="heading_<?php echo $type; ?>" data-bs-parent="#accordion">
